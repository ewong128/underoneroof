...
function PreferencesForm(props) {
  ...
  function validateForm(data) {
    ...
    if (!data.preferredContact) validationErrors.preferredContact = "Preferred contact method is required";
    if (data.preferredContact === "Other" && !data.preferredContactOther) validationErrors.preferredContactOther = "Please specify the preferred contact method";
    if (!data.responseTime) validationErrors.responseTime = "Response time is required";
    if (data.responseTime === "Other" && !data.responseTimeOther) validationErrors.responseTimeOther = "Please specify the response time";
    if (!data.challengingConversation) validationErrors.challengingConversation = "Challenging conversation method is required";
    if (data.challengingConversation === "Other" && !data.challengingConversationOther) validationErrors.challengingConversationOther = "Please specify the conversation method";
    if (!data.weekdaySleepHours) validationErrors.weekdaySleepHours = "Weekday sleep hours are required";
    if (!data.weekendSleepHours) validationErrors.weekendSleepHours = "Weekend sleep hours are required";
    if (!data.quietStudyTime) validationErrors.quietStudyTime = "Quiet study time is required";
    if (!data.studyHouseCondition) validationErrors.studyHouseCondition = "Study house condition is required";
    if (!data.sharingPossessions) validationErrors.sharingPossessions = "Sharing possessions policy is required";
    if (data.guestsPolicy.other && !data.guestsPolicy.guestsPolicyOther) validationErrors.guestsPolicyOther = "Please specify the guest policy";
  ...
  return (
    <form onSubmit={submitForm} className="preferences-form-container" style={{ padding: "20px", fontFamily: "Arial, sans-serif", maxWidth: "600px", margin: "0 auto", border: "1px solid #ccc", borderRadius: "10px" }}>
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.preferredContact && <span style={{ color: "red" }}>{errors.preferredContact}</span>}
        {errors.preferredContactOther && <span style={{ color: "red" }}>{errors.preferredContactOther}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.responseTime && <span style={{ color: "red" }}>{errors.responseTime}</span>}
        {errors.responseTimeOther && <span style={{ color: "red" }}>{errors.responseTimeOther}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.challengingConversation && <span style={{ color: "red" }}>{errors.challengingConversation}</span>}
        {errors.challengingConversationOther && <span style={{ color: "red" }}>{errors.challengingConversationOther}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        />
        {errors.weekdaySleepHours && <span style={{ color: "red" }}>{errors.weekdaySleepHours}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        />
        {errors.weekendSleepHours && <span style={{ color: "red" }}>{errors.weekendSleepHours}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.quietStudyTime && <span style={{ color: "red" }}>{errors.quietStudyTime}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.studyHouseCondition && <span style={{ color: "red" }}>{errors.studyHouseCondition}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.sharingPossessions && <span style={{ color: "red" }}>{errors.sharingPossessions}</span>}
      </div>
      <div style={{ marginBottom: "15px" }}>
        ...
        {errors.guestsPolicy && <span style={{ color: "red" }}>{errors.guestsPolicy}</span>}
        {errors.guestsPolicyOther && <span style={{ color: "red" }}>{errors.guestsPolicyOther}</span>}
      </div>
      <button
        type="submit"
        disabled={isSubmitting}
        style={{ padding: "10px 20px", backgroundColor: "#00AA9E", borderColor: "#0a978d", color: "#fff", fontSize: "16px", cursor: isSubmitting ? "not-allowed" : "pointer", borderRadius: "5px" }}
      >
